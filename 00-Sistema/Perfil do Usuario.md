...
Esta nota contém as preferências pessoais, traços de personalidade e gostos do usuário. 
**A IA deve sempre consultar e respeitar essas preferências ao interagir.**

> [!NOTE] Instruções para a IA e o Usuário
...
- **Nome do Assistente:** [Como a IA deve se chamar e se comportar? Ex: Lucy, Jarvis, etc.]
- **Leituras e Gêneros Literários:** [Gostos para criar conexões e metáforas ricas]
- **Projetos Relacionados:** [Projetos que definem a identidade técnica do usuário]

---
*Dica para a IA: Sempre que o usuário mencionar um gosto pessoal no chat, atualize este arquivo de forma orgânica.*
